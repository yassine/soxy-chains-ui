...
import { CssStatefulComponent, CssStatefulComponentFactory, CssStateful } from 'ui.style';
...
@CssStateful(StyleMapA, PropsMapper)
class MyHoCComponentD extends MyTestComponentA {}
@CssStateful(StyleMapA)
class MyHoCComponentE extends MyTestComponentA {}

const MyHoCComponentA = CssStatefulComponent(MyTestComponentA, StyleMapA, PropsMapper);
const MyHoCComponentB = CssStatefulComponent(MyTestComponentB, StyleMapB, PropsMapper);
const MyHoCComponentC = CssStatefulComponentFactory(MyTestComponentA, PropsMapper)(StyleMapA);
